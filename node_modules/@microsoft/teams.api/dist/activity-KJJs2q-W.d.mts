...
import { ISuggestedActionSubmitInvokeActivity } from './activities/invoke/suggested-action-submit.mjs';
...
import './activities/invoke/message/fetch-task.mjs';
...
type InvokeActivity = IFileConsentInvokeActivity | IExecuteActionInvokeActivity | MessageExtensionInvokeActivity | ConfigInvokeActivity | TabInvokeActivity | TaskInvokeActivity | MessageInvokeActivity | IHandoffActionInvokeActivity | SignInInvokeActivity | AdaptiveCardInvokeActivity | ISuggestedActionSubmitInvokeActivity;
...
declare class ConversationActivityClient {
    ...
    getMembers(conversationId: string, id: string): Promise<TeamsChannelAccount[]>;
    createTargeted(conversationId: string, params: ActivityParams): Promise<Resource>;
    updateTargeted(conversationId: string, id: string, params: ActivityParams): Promise<Resource>;
    deleteTargeted(conversationId: string, id: string): Promise<void>;
}

export { type Activity as A, ConversationActivityClient as C, type IMessageExtensionFetchTaskInvokeActivity as I, type MessageExtensionInvokeActivity as M, type SentActivity as S, type ActivityLike as a, type ActivityParams as b, type IMessageExtensionSubmitActionInvokeActivity as c, type InvokeActivity as d, type MessagingExtensionAction as e, toActivityParams as t };
