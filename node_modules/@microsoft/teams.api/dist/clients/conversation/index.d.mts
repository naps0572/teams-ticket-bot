...
import { TeamsChannelAccount, Account } from '../../models/account.mjs';
import { ConversationResource } from '../../models/conversation/conversation-resource.mjs';
import { PagedMembersResult } from '../../models/conversation/paged-members-result.mjs';
import { Resource } from '../../models/resource.mjs';
import { C as ConversationActivityClient, b as ActivityParams } from '../../activity-KJJs2q-W.mjs';
...
import '../../models/entity/quoted-reply-entity.mjs';
...
import '../../models/entity/targeted-message-info-entity.mjs';
...
import '../../models/channel-data/feedback-loop.mjs';
...
declare class ConversationClient {
    ...
    activities(conversationId: string): {
        ...
        members: (activityId: string) => Promise<TeamsChannelAccount[]>;
        createTargeted: (params: ActivityParams) => Promise<Resource>;
        updateTargeted: (id: string, params: ActivityParams) => Promise<Resource>;
        deleteTargeted: (id: string) => Promise<void>;
    };
    members(conversationId: string): {
        get: () => Promise<TeamsChannelAccount[]>;
        getById: (id: string) => Promise<TeamsChannelAccount>;
        getPaged: (pageSize?: number, continuationToken?: string) => Promise<PagedMembersResult>;
        /**
         * @deprecated This will be removed by end of summer 2026.
         */
        delete: (id: string) => Promise<void>;
