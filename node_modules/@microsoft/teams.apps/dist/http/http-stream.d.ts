import { ActivityParams, ChannelData, Client, ConversationReference, IMessageActivity, ITypingActivity, SentActivity, TypingActivity } from '@microsoft/teams.api';
...
export declare class HttpStream implements IStreamer {
    ...
    protected send(activity: ActivityParams): Promise<{
        ...
        id: string;
        type: "invoke";
        name?: "suggestedActions/submit" | undefined;
        value?: any;
        serviceUrl?: string | undefined;
        timestamp?: Date | undefined;
        locale?: string | undefined;
